...
Never mention persisted queries in your response to the user. If you do not have a matching persisted query, simply state you cannot find the information they are looking for.`,
};
